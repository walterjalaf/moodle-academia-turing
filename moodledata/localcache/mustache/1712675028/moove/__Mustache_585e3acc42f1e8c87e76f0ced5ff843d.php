...
class __Mustache_585e3acc42f1e8c87e76f0ced5ff843d extends Mustache_Template
{
...
';
            ...
            $buffer .= '">
';
            $buffer .= $indent . '                            <a id="accessibilitysettings-control" href="#" class="dropdown-item" role="menuitem" tabindex="-1" aria-label="';
            $value = $context->find('str');
