...
class __Mustache_d3f7a746c24c7c57160e2cb7f90118c7 extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->sectionCb3f70690f69f98406a888f59162b145($context, $indent, $value);
            $buffer .= $indent . '                </div>
';
        }
        $buffer .= $indent . '
';
        ...
        if (empty($value)) {
            ...
            $value = $context->find('activityinformation');
            $buffer .= $this->section615c3741f3fd249ace74c3da3cf80744($context, $indent, $value);
        }
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
...
';
        ...
        $buffer .= $this->section21a99fe7c17ac22a7f98da6b22e84c77($context, $indent, $value);
        $buffer .= $indent . '    </span>
';
        $value = $context->find('useSubtiles');
        if (empty($value)) {
...
';
    ...
    private function sectionCb3f70690f69f98406a888f59162b145(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section615c3741f3fd249ace74c3da3cf80744(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                if ($partial = $this->mustache->loadPartial('format_tiles/activity_info')) {
                    $buffer .= $partial->renderInternal($context, $indent . '                    ');
                }
                $context->pop();
            }
...
';
    ...
    private function section0f325126e4902777d002ac526cdf147f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section21a99fe7c17ac22a7f98da6b22e84c77(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section0f325126e4902777d002ac526cdf147f($context, $indent, $value);
                $context->pop();
            }
        }
