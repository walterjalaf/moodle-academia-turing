...
class __Mustache_9992a6db4a95ed1089951e33338d0e8e extends Mustache_Template
{
...
';
        $buffer .= $indent . '        ';
        $value = $this->resolveValue($context->findDot('output.get_module_footer_callbacks_data'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <div class="moove-container-fluid p-0 mb-4">
';
        $buffer .= $indent . '            ';
