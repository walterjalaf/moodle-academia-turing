...
class __Mustache_698f7ac4f90313183d692fff92e4e2f4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0652f53d5f8f0b4b043ff385e32a79f2($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section9baf2dce4efaf8282427c7fc0a61c63b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0652f53d5f8f0b4b043ff385e32a79f2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section9baf2dce4efaf8282427c7fc0a61c63b($context, $indent, $value);
                $context->pop();
            }
        }
