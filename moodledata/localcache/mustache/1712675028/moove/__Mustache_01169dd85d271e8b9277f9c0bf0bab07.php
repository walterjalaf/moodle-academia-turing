...
class __Mustache_01169dd85d271e8b9277f9c0bf0bab07 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'block26d65f61f75f74c42f7a7e1a557e7fbe'),
...
';
    ...
    public function block26d65f61f75f74c42f7a7e1a557e7fbe($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <i class="icon fa-regular fa-bell" title="';
        $value = $context->find('str');
