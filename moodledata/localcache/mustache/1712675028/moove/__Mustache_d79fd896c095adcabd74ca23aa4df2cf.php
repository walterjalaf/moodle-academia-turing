...
class __Mustache_d79fd896c095adcabd74ca23aa4df2cf extends Mustache_Template
{
...
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '    .format-tiles .embed_cm_modal .modal-header h5,
';
        $buffer .= $indent . '    .format-tiles .embed_cm_modal .modal-header h4 {
';
        $buffer .= $indent . '        color: #fff;
';
        $buffer .= $indent . '    }
';
        $buffer .= $indent . '    .format-tiles .embed_cm_modal .modal-header .close {
';
        $buffer .= $indent . '        color: #fff;
';
