...
{ "ER_STACK_OVERRUN", 1119, "Thread stack overrun:  Used: %ld of a %ld stack. Consider increasing the thread_stack system variable" },
...
{ "ER_TRANS_CACHE_FULL", 1197, "Multi-statement transaction required more than \'max_binlog_cache_size\' bytes of storage" },
...
{ "ER_JSON_DEPTH", 4040, "Limit of %d on JSON nested strucures depth is reached in argument %d to function \'%s\' at position %d" },
...
{ "ER_SEQUENCE_INVALID_DATA", 4085, "Sequence \'%-.64s.%-.64s\' values are conflicting" },
